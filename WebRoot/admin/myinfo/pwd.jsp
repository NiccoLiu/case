...
<body>
	...
	<form action="<%=path %>/admin/pwdOk.do" id="form" method="post">
	<table class="table table-bordered" style="width:400px" align="center">
		<tr>
			<td width="50%" align="right" bgcolor="#f1f1f1">原密码：</td>
			<td width="50%">
				<input type="password" readonly="readonly" value="${requestScope.admin.admin_pwd}" class="span1-1" />
				<input type="hidden" name="adId" value="${requestScope.admin.id}" class="span1-1" />
			</td>
		</tr>
		<tr>
