...
<script type="text/javascript">
	function del(id){
		if(confirm("是否删除该记录?")){
			alert("删除成功!");
			location="<%=path%>/admin/suffererDel.do?suf_id="+id;
		}
	}
</script>
</head>
<body>
	<div class="right_cont">
		<ul class="breadcrumb">当前位置：人员管理<span class="divider">/</span></span>患者管理</ul>
	</div>
	<div class="title_right"><strong>患者管理</strong></div>
	
	<form action="<%=path %>/admin/suffererList.do" id="form" method="post">
	...
	<table width="90%" class="table table-bordered table-striped table-hover">
     <tbody>
       <tr align="center">
         ...
         <td width="6%" nowrap="nowrap"><strong>所属医生</strong></td>
       ...
       <tr align="center">
         ...
         <td nowrap="nowrap">${suf.doc_name}</td>
         <td nowrap="nowrap">
         ...
         <td nowrap="nowrap"><a href="<%=path%>/admin/suffererUpdate.do?id=${suf.id}">编辑</a> | <a href="javascript:void(0)" onclick="del('${suf.id}')">删除</a></td>
       </tr>
      </c:forEach>
     </tbody>
   </table>
