...
<body>
	<div class="right_cont">
		<ul class="breadcrumb">当前位置：科室管理<span class="divider">/</span></span>添加科室</ul>
	</div>
	<div class="title_right"><strong>添加科室</strong></div>
	<form action="<%=path %>/admin/departmentAddOk.do" id="form" method="post">
	<table class="table table-bordered" style="width:400px" align="center">
		<tr>
			<td width="50%" align="right" bgcolor="#f1f1f1">科室名称：</td>
			<td width="50%">
				<input type="text" name="dep_name" maxlength="20" id="dep_name" class="span1-1" />
			</td>
		</tr>
		<tr>
			<td width="50%" align="right" bgcolor="#f1f1f1">备注：</td>
			<td width="50%">
				<textarea rows="3" name="dep_remark" id="dep_remark" cols="30"></textarea>
			</td>
		</tr>
	</table>
